...
//   {id:crypto.randomUUID(),name:'midium',price: 3 },
//   {id:crypto.randomUUID(),name:'large',price: 5},
//   {id:crypto.randomUUID(),name:'xLarge',price: 10}
// ];
// const extras =  [
...
type="button"
size='lg'
className=" mt-4 rounded-full text-white !px-8"
>
    <span>
        Add to Cart
    </span>
...
{item.name}
      ...
      <div className="space-y-10 ">
       ...
       <Label htmlFor="pick-size" className="text-lg font-bold text-gray-900" > pick your size</Label>
       ...
       />
        ...
        <div className="space-y-4 text-center">
                 <Label htmlFor="add-extras" className="text-lg font-bold text-gray-900" > Any Extras</Label>
